...
# Similar ao health mas pode incluir verificações adicionais
@router.get(
    "/ready",
    tags=["Health"],
...
# Liveness probe - Verifica se API está viva (não travada)
# Usado por Kubernetes para reiniciar containers travados
@router.get(
    "/live",
    tags=["Health"],
